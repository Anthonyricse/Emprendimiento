 ...
 * @author Toshiba
 */
public class ControladorAcuaNosotros {
    private UsuarioArreglo modelo ;
     private frmAcuaNosotros vista ; 

    public ControladorAcuaNosotros(UsuarioArreglo modelo, frmAcuaNosotros vista) {
        this.modelo = modelo;
        this.vista = vista;
        this.vista.btnRetornoA.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                vista.dispose();
                frmAcuario1 facuar = new frmAcuario1();
                ControladorAcuario controla = new ControladorAcuario(sistema.usuarios, facuar);
                controla.iniciar();
            }
        });
