 ...
 * @author Toshiba
 */
public class frmRestaurant5 extends javax.swing.JFrame {

    /**
     * Creates new form frmRestaurant3
     */
    public frmRestaurant5() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAfterR, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 443, 30, 28));

        btnNextR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Botones/nextR.png"))); // NOI18N
        getContentPane().add(btnNextR, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 443, 30, 30));

        btnMapaR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Botones/mapaR.png"))); // NOI18N
        getContentPane().add(btnMapaR, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 440, 38, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Fondos/fondRestaurant5.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRestaurant5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRestaurant5().setVisible(true);
            }
        });
    }
